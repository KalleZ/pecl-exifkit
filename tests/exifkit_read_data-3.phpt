...
--FILE--
<?php
var_dump(exifkit_read_data(__DIR__ . '/test-3.jpg'));
?>
--EXPECT--
array(5) {
  ["IFD0"]=>
  ...
  array(8) {
    ...
    string(1) "N"
    ["GPSLatitude"]=>
    string(24) "43.0000, 16.0000, 7.5363"
    ["GPSLongitudeRef"]=>
    string(1) "E"
    ["GPSLongitude"]=>
    string(25) "77.0000, 21.0000, 53.3469"
    ["GPSAltitudeRef"]=>
    string(9) "Sea level"
    ["GPSAltitude"]=>
    string(8) "1603.000"
